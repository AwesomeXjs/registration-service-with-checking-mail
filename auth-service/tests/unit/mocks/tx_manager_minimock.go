...
//go:generate minimock -i github.com/AwesomeXjs/registration-service-with-checking-mail/auth-service/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/AwesomeXjs/registration-service-with-checking-mail/auth-service/pkg/db"
